...
function BIC_text_Callback(hObject, eventdata, handles)
% hObject    handle to BIC_text (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of BIC_text as text
%        str2double(get(hObject,'String')) returns contents of BIC_text as a double


% --- Executes during object creation, after setting all properties.
function BIC_text_CreateFcn(hObject, eventdata, handles)
% hObject    handle to BIC_text (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
